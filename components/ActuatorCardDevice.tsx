      ...
      <div>
        ...
        {loading ? <div className="py-8 flex justify-center"><LoadingSpinner/></div> : (
          <div className="mt-4 space-y-3">
            ...
            <div className="flex justify-between items-center"><span className="font-medium">Lampu</span><ToggleSwitch checked={states?.['17'] === 0} onChange={(val) => handleActuatorChange(17, val)} disabled={modeAuto} /></div>
            <div className="flex justify-between items-center"><span className="font-medium">Misting</span><ToggleSwitch checked={states?.['18'] === 0} onChange={(val) => handleActuatorChange(18, val)} disabled={modeAuto} /></div>
          </div>
        )}
      </div>
